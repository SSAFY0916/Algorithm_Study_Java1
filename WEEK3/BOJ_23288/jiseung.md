...
> 주사위 전개도를 항상 유지하면서 아랫면에 어떤 수가 있는지 항상 알 수 있게 했다.
칸마다 획득할 수 있는 점수를 BFS를 통해 미리 계산해 놓았다.
> 

# **📑Related Issues**

> 주사위를 굴리는 것을 상상하면서 구현하는게 어려웠다.
중간에 주사위의 아랫면이 같으면 옆면의 모양도 같다고 착각했었다.
주사위를 굴리는 코드를 좀 재사용할 수 있게 작성했으면 좋았을 것 같다.
> 
