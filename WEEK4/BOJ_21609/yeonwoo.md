...
> [BOJ 21609 상어중학교](https://www.acmicpc.net/problem/21609)
...
#가장 큰 그룹 찾기
- 행열탐색을 하면서 일반블록이 나오면 bfs 탐색을 하였습니다
- 행열탐색을 하면 무지개 블록의 수를 제외한 동점처리가 자동으로 됩니다.
- bfs탐색이 한 번 끝날 때 마다 무지개 블록만 visit = false 처리를 해서 
무지개블록만 재사용 가능하도록 하였습니다.
...
> 무지개블록 초기화 안해서 최대 그룹 탐색에 난항을 겪었습니다.
>
> 
