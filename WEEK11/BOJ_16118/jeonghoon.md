...
> 다익스트라 알고리즘을 해당 지점까지 빠르게 가는 경우, 느리게 가는 경우 두 가지로 구분하여 구현하였습니다.
...
> 로직 자체를 생각해서 구현해 내는 것은 크게 어렵지 않았으나 자꾸 시간초과가 발생해서, PQ를 람다식 대신 CompareTo overriding으로도 바꿔보고, 별의 별 짓을 다 해보다가, 입출력 관련 코드를 구글에서 찾아서 속도를 향상시켜보니 통과하게 되었습니다...
